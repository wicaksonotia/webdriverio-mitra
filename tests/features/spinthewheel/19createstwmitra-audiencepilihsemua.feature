Feature: 19. Create STW Mitra (Audience Pilih Semua)

  Scenario Outline: As a user, I can create SWT mitra
    ...
    When I click button Simpan in tab Detail Program form
    Then System save data in tab Detail Program form

    When I click tab Audience
    Then system should be leading to Audience

    When I select radio button Pilih Semua
    Then System should be able to select radio button Pilih Semua

    When I click button Update Semua
    Then System should be able to Update Audience
    ...
    Then system should be leading to program berjalan
     ...
     Examples:
      ...
      | STW AUDIENCE PILIH SEMUA 2003   | 500000       |  10000                  | 100                    | 1                         | 2                         | 5     | 4     | 3     | 2     | 1     | 30          | 25          | 20          | 15          | 10          |
