Feature: 20. Create STW Mitra (Berdasarkan Tier)

Scenario Outline: As a user, I can create SWT mitra Berdasarkan Tier
Given I am on the Spin the Wheel page
    ...
    Then System should be able to show checkbox tier

    When I click checkbox pilih tier and update
    Then System should be able click tier and click button update tier
    ...
    Then system should be able to click button publish spin the wheel
...
Examples:
      ...
      | STW AUDIENCE-TIER | 100000       |  500                    | 50                     | 1                         | 2                         | 5     | 4     | 3     | 2     | 1     | 30          | 25          | 20          | 15          | 10          |
