Feature: 23. Create STW Mitra (Batasan 1 Produk)

Scenario Outline: As a user, I can create SWT mitra Batasan 1 Produk 
    ...
    Then system should be able to input min Value
    ...
    Then System should be able to select dropdown pilih tier

    When I click pilih tier
    Then System should be able to select checkbox tier
    
    When I click pilih tier gold
    Then System should be able to select tier gold
...
Examples:
    | nama_program             | total_budget | minimum_nilai_transaksi | limit_spin_keseluruhan | min_value | minimum_frekuensi_belanja | maksimal_frekuensi_reward | poin1 | poin2 | poin3 | poin4 | poin5 | kesempatan1 | kesempatan2 | kesempatan3 | kesempatan4 | kesempatan5 |
    | STW BATASAN 1 PRODUK     | 9250000      |  1000                   | 100                    | 13000     | 1                         | 2                         | 5     | 4     | 3     | 2     | 1     | 30          | 25          | 20          | 15          | 10          |
