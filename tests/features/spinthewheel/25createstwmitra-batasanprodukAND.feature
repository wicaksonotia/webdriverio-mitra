Feature: 25. Create STW Mitra (Batasan Produk AND)

Scenario Outline: As a user, I can create SWT mitra Batasan Poduk AND
    ...
    When I select Sampoerna A Filter 12 in listbox
    Then system should be able to select Sampoerna A Filter 12

    When I input min Value Sampoerna A Filter 12 <min_value>
    Then system should be able to input min Value Sampoerna A Filter 12

    When I input cari produk disini in Pembatasan Produk2
    Then system should show listbox2

    When I select Marlboro Red 20 in listbox
    Then system should be able to select Marlboro Red 20

    When I input min Value Marlboro Red 20 <min_value2>
    Then system should be able to input min Value Marlboro Red 20

    When I click radio button AND in Pembatasan Produk
    Then system should be able to click radio button AND
...
Examples:
    ...
    | STW BATASAN AND     | 1650000      |  1000                   | 100                    | 15000     | 19000      | 1                         | 2                         | 5     | 4     | 3     | 2     | 1     | 30          | 25          | 20          | 15          | 10          |