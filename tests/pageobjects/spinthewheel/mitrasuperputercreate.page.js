...
import { setStartDate, setEndDate } from "../../helper/command";

//sub page containing specific selectors and methods for a specific page
class mitraSuperPuterCreatePage extends Page {
  //define selectors using getter methods
  get titlePage() {
    return $('[class="h1 mt-16"]');
  }
  get titleTabPage() {
  ...
  get inputNamaProgram() {
    return $('[placeholder="Nama program Spin the Wheel"]');
  }
  get inputTotalBudget() {
    return $('[formcontrolname="total_budget"]');
  }
  get calendarTanggalMulai() {
    return $('[formcontrolname="tanggal_mulai"]');
  }
  get calendarTanggalBerakhir() {
    return $('[formcontrolname="tanggal_berakhir"]');
  }
  get popUpCalendar() {
    return $("mat-datepicker-content tbody.mat-calendar-body");
  }
  get popupJamMulai() {
    return $('[formcontrolname="jam_mulai"]');
  }
  get popupJamBerahir() {
    return $('[formcontrolname="jam_berakhir"]');
  }
  ...
  get inputMinimumFrekuensiBelanja() {
    return $('[formcontrolname="shopping_frequency"]');
  }
  get inputMaksimalFrekuensiReward() {
    return $('[formcontrolname="reward_frequency"]');
  }
  get searchPembatasanProduk() {
    return $('[placeholder="Cari produk disini"]');
  }
  get dropDownPembatasaProduk() {
    return $$('[role="option"]');
  }
  get productContainer() {
    return $('[formarrayname="limit_only"]');
  }
  get productContainer2() {
    return $$('[formarrayname="limit_only"]');
  }
  get inputMinValue() {
    return $('[formcontrolname="min_value"]');
  }
  get inputMinValue2() {
    return $$('[formcontrolname="min_value"]');
  }
  get radioBtnPembatasanProduk() {
    return $$('[class="mat-radio-container"]');
  }
  get buttonSimpanDetailProgram() {
    return $('[class="confirmation-button mat-raised-button mat-warn"]');
  }
  ...
  get radiobtnPilihSemua() {
    return $$("div.mat-radio-container");
  }
  get radiobtnberdasarkanTier() {
    return $("#mat-radio-3");
  }
  get buttonUpdate() {
    return $("button.mat-raised-button.mat-warn");
  }
  get buttonSimpanAudience() {
    return $('[class="confirmation-button mat-raised-button mat-warn"]');
  }
  get content() {
    return $('[class="mat-card-content"]');
  }
  get dropdownPilihTier() {
    return $("div.mat-select-value");
  }
  get optionTier() {
    return $$('[role="option"]');
  }
  get buttonExportCSV() {
    return $('[class="mat-stroked-button"]');
  }
  get buttonImportCSV() {
    return $('[class="mat-stroked-button ng-star-inserted"]');
  }
  get buttonKirim() {
  ...
  get closePopupInsertFile() {
    return $('[class="mat-icon-button"]');
  }
  get inputSearch() {
    return $('[placeholder="Cari Nama Toko/Nomor Ponsel"]');
  }
  get dataTabel() {
    return $(
      '[class="material shadow-none ngx-datatable fixed-header virtualized scroll-horz selectable checkbox-selection"]'
    );
  }
  get checkboxCA() {
    return $$('[class="mat-checkbox-layout"]');
  }
  get checkboxPelanggan() {
    return $('[class="mat-checkbox mat-accent ng-star-inserted"]');
  }
  get tabelCustomAudience() {
    return $('[class="datatable-body"]');
  }
  get nextPage() {
    return $('[class="mat-paginator-navigation-next mat-icon-button"]');
  }
  get backPage() {
    return $('[class="mat-paginator-navigation-previous mat-icon-button"]');
  }

  //pengaturan mekanisme page
  get inputPoin() {
    return $$('[formcontrolname="point"]');
  }
  get inputKesempatan() {
    return $$('[formcontrolname="probability"]');
  }
  get buttonPerbaruiContoh() {
    return $('[class="mat-stroked-button mat-warn"]');
  }
  get buttonPublishkeApk() {
    return $('[class="mat-raised-button mat-warn"]');
  }

  //program berjalan
  get containerProgramBerjalan() {
    return $('[class="p-24 ng-untouched ng-pristine ng-valid"]');
  }
  ...
  async tanggalMulai() {
    ...
    await setStartDate(this.calendarTanggalMulai, this.popUpCalendar);
  }
  ...
  async tanggalBerakhir1() {
    ...
    //  await this.popUpCalendar.waitForDisplayed();
    //  await this.popUpCalendar.$$("tr")[4].$$("td")[2].$("div").click();
    await setStartDate(this.calendarTanggalBerakhir, this.popUpCalendar);
  }
