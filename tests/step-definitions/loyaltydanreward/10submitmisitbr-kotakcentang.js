...
allureReporter.addTestId('[MITRA] 10. Submit Misi TBR (ke Kotak Centang)');
allureReporter.addFeature('Submit Misi TBR (ke Kotak Centang)');
...
When(/^I do and submit questionnaire form$/, async () => {
    await IsiKuesionerPage.keCentang()
});
