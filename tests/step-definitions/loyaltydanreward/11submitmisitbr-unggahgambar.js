...
allureReporter.addTestId('[MITRA] 11. Submit Misi TBR (ke Unggah Gambar)');
allureReporter.addFeature('Submit Misi TBR (ke Unggah Gambar)');
...
When(/^I do and submit questionnaire form$/, async () => {
    await IsiKuesionerPage.keUnggah()
});
