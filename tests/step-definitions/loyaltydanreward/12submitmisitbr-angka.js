...
allureReporter.addTestId('[MITRA] 12. Submit Misi TBR (ke Angka)');
allureReporter.addFeature('Submit Misi TBR (ke Angka)');
...
When(/^I do and submit questionnaire form$/, async () => {
    await IsiKuesionerPage.keAngka(dataTest.jawabanKuesioner.angka)
});
