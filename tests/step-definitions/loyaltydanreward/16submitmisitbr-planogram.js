...
allureReporter.addTestId('[MITRA] 16. Submit Misi TBR (ke Planogram)');
allureReporter.addFeature('Submit Misi TBR (ke Planogram)');
...
When(/^I do and submit questionnaire form$/, async () => {
    await IsiKuesionerPage.kePlanogramIR()
});
