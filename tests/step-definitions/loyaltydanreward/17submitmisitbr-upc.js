...
allureReporter.addTestId('[MITRA] 17. Submit Misi TBR (ke UPC)');
allureReporter.addFeature('Submit Misi TBR (ke UPC)');
...
When(/^I do and submit questionnaire form$/, async () => {
    await IsiKuesionerPage.keUPC(dataTest.jawabanKuesioner.UPC)
});
