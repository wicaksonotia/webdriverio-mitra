...
allureReporter.addTestId('[MITRA] 05. Submit Misi TBR (ke Jawaban Singkat)');
allureReporter.addFeature('Submit Misi TBR (ke Jawaban Singkat)');
...
When(/^I do and submit questionnaire form$/, async () => {
    await IsiKuesionerPage.keSingkat(dataTest.jawabanKuesioner.jawabanSingkat)
});
