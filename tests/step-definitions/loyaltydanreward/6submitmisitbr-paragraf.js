...
allureReporter.addTestId('[MITRA] 06. Submit Misi TBR (ke Paragraf)');
allureReporter.addFeature('Submit Misi TBR (ke Paragraf)');
...
When(/^I do and submit questionnaire form$/, async () => {
    await IsiKuesionerPage.keParagraf(dataTest.jawabanKuesioner.paragraf)
});
