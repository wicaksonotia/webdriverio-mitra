...
allureReporter.addTestId('[MITRA] 07. Submit Misi TBR (ke Pilgan Angka)');
allureReporter.addFeature('Submit Misi TBR (ke Pilgan Angka)');
...
When(/^I do and submit questionnaire form$/, async () => {
    await IsiKuesionerPage.kePilganAngka(dataTest.jawabanKuesioner.angka)
});
