...
allureReporter.addTestId('[MITRA] 09. Submit Misi TBR (ke Pilgan Paragraf)');
allureReporter.addFeature('Submit Misi TBR (ke Pilgan Paragraf)');
...
When(/^I do and submit questionnaire form$/, async () => {
    await IsiKuesionerPage.kePilganParagraf(dataTest.jawabanKuesioner.paragraf)
});
