...
allureReporter.addTestId('[MITRA] 21. Create Program STW Mitra (Audience - Upload Audience)');
allureReporter.addFeature('Create Program STW Mitra (Audience - Upload Audience)');
...
When (/^I select radio button upload audience$/, async () => {
    await mitraSuperPuterCreatePage.uploadAudience()
});

Then (/^system should be select radio button upload audience and show button Export CSV and Import CSV$/, async () => {
    await mitraSuperPuterCreatePage.AudienceTabPage()
});

When (/^I click button Export CSV$/, async () => {
    await mitraSuperPuterCreatePage.exportCSV()
});

Then (/^system should be click button Import and download template file$/, async () => {
    await mitraSuperPuterCreatePage.AudienceTabPage()
});

When (/^I click button import CSV$/, async () => {
    await mitraSuperPuterCreatePage.importCSV()
});

Then (/^system should be click button Import and show popup upload file$/, async () => {
    await mitraSuperPuterCreatePage.AudienceTabPage()
});

When (/^I insert file in unggah file$/, async () => {
    await mitraSuperPuterCreatePage.insertFile()
});

Then (/^system should be able to insert file data pengguna$/, async () => {
    await mitraSuperPuterCreatePage.AudienceTabPage()
});

When (/^I click button kirim$/, async () => {
    await mitraSuperPuterCreatePage.btnKirim()
});

Then (/^system should be able to submit file data pengguna$/, async () => {
    await mitraSuperPuterCreatePage.AudienceTabPage()
});
...
When (/^I click button ubah$/, async () => {
    await mitraSuperPuterCreatePage.btnUbah()
});

Then (/^system should be able to show popup upload file2$/, async () => {
    await mitraSuperPuterCreatePage.AudienceTabPage()
});

When (/^I insert file in unggah file2$/, async () => {
    await mitraSuperPuterCreatePage.insertFile()
});

Then (/^system should be able to insert file data pengguna2$/, async () => {
    await mitraSuperPuterCreatePage.AudienceTabPage()
});

When (/^I click button kirim2$/, async () => {
    await mitraSuperPuterCreatePage.btnKirim()
});

Then (/^system should be able to submit file data pengguna2$/, async () => {
    await mitraSuperPuterCreatePage.AudienceTabPage()
});

When (/^I click button Update Audience2$/, async () => {
    await mitraSuperPuterCreatePage.updateAudience()
});

Then (/^system should be able to update data in target audience2$/, async () => {
    await mitraSuperPuterCreatePage.AudienceTabPage()
});
