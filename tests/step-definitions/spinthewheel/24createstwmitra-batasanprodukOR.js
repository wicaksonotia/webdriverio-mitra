...
allureReporter.addTestId('[MITRA] 24. Create Program STW Mitra - Batasan Produk OR');
allureReporter.addFeature('Create Program STW Mitra - Batasan Produk OR');
...
When (/^I select Test Poduct in listbox Pembatasan Produk$/, async () => {
    await mitraSuperPuterCreatePage.selectTestProduct()
});

Then (/^system should be able to select Test Poduct$/, async () => {
    await mitraSuperPuterCreatePage.DetailProgramPage()
});

When (/^I input min Value Test Product (.*)$/, async (min_value) => {
    await mitraSuperPuterCreatePage.MinValue(min_value)
});

Then (/^system should be able to input min Value Test Product$/, async () => {
    await mitraSuperPuterCreatePage.DetailProgramPage()
});
...
Then (/^system should be able to input show listbox2$/, async () => {
    await mitraSuperPuterCreatePage.DetailProgramPage()
});

When (/^I select Wafer Duta Milk Cocopandan in listbox$/, async () => {
    await mitraSuperPuterCreatePage.selectWaferDutaMilk()
});

Then (/^system should be able to select Wafer Duta Milk Cocopandan$/, async () => {
    await mitraSuperPuterCreatePage.DetailProgramPage()
});

When (/^I input min Value Wafer Duta Milk Cocopandan (.*)$/, async (min_value2) => {
    await mitraSuperPuterCreatePage.MinValue2(min_value2)
});

Then (/^system should be able to input min Value Wafer Duta Milk Cocopandan$/, async () => {
    await mitraSuperPuterCreatePage.DetailProgramPage()
});

When (/^I click radio button OR in Pembatasan Produk$/, async () => {
    await mitraSuperPuterCreatePage.pembatasanProdukOR()
});

Then (/^system should be able to click radio button OR$/, async () => {
    await mitraSuperPuterCreatePage.DetailProgramPage()
});
...
When (/^I click pilih tier basic$/, async () => {
    await mitraSuperPuterCreatePage.optionTierBasic()
});

Then (/^System should be able to click tier basic$/, async () => {
    await mitraSuperPuterCreatePage.AudienceTabPage()
});
